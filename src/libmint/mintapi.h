...
void rsesc_spawn(Pid_t ppid, Pid_t cpid, long flags);
...
void rsesc_record_system_call(int pid, unsigned long retVal);
...
void rsesc_syscall_retval(int pid, long value);
...
void rsesc_spawn(int ppid, int pid, long flags);
