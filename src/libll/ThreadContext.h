...
public:
 ...
 private:
  ...
  SignalTable *sigTable;
 public:
  void setSignalState(SignalState *newSigState){
    sigState=newSigState;
  }
  void setSignalTable(SignalTable *newSigTable){
    sigTable=newSigTable;
  }
  SignalState *getSignalState(void) const{
    return sigState;
  }
 ...
 public:
  ...
  void doHarvest(int id){
    I(childIDs.find(id)!=childIDs.end());
    childIDs.erase(id);
  }
